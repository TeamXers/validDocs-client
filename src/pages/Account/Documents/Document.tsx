...
export const ViewDocument: React.FC<ViewDocumentProps> = ({ breadcrumbs }) => {
    ...
    const blockchainUrl = Testnet.getExplorerTransactionLink(
        document?.tranxHash ?? ""
    );
                    ...
                    <Box sx={{ width: { xs: "100%", md: "60%" } }}>
                        ...
                        <Box mt={4}>
                            ...
                            <Box display='flex' alignItems='center' mb={1}>
                                {document?.authorAddress && <User address={document.authorAddress} />}
                            </Box>

                            <Typography variant='caption'>
                                <LoaderOrContent transition={transition}>
                                    Created on {document?.createdAt && formatDate(document.createdAt)}
                                </LoaderOrContent>
                            </Typography>
                        </Box>
                    </Box>
